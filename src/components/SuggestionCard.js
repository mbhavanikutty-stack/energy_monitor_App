        ...
        <div className="card-details">
          <div className="detail-item">
            ...
            <span className="detail-text">
              {implementationTime || "Quick setup"}
            </span>
          </div>
          {difficulty && (
            <div className="detail-item">
...
export const getIconForTip = (tip) => {
  ...
  if (tipLower.includes("appliance") || tipLower.includes("unplug"))
    return "🔌";
  ...
  if (tipLower.includes("smart") || tipLower.includes("automation"))
    return "📱";
  if (tipLower.includes("energy") || tipLower.includes("efficient"))
    return "⚡";
